...
public class RentalController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Bicycle already rented or user cannot rent"),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Rental already completed or concurrent modification"),
