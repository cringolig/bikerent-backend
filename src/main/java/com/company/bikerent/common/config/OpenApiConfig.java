    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                ...
                .tags(List.of(
                        ...
                        new Tag().name("Repairs").description("Bicycle repair management (Tech/Admin only)"),
                ...
                .components(new Components()
                        ...
                        .addSecuritySchemes(bearerAuthScheme, new SecurityScheme()
                                ...
                                .scheme("bearer")
                                .bearerFormat("JWT")
                                .description("JWT access token. Obtain via `/api/v1/auth/login` or `/api/v1/auth/register`"))
