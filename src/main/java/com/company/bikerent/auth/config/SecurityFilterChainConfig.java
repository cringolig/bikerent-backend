 ...
 * Configures CORS, CSRF, security headers, and authorization rules.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityFilterChainConfig {
     ...
     */
    private static final String[] TECH_ADMIN_URLS = {
            "/api/v1/repairs/**",
            "/api/v1/technicians/**"
    };
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers(TECH_ADMIN_URLS).hasAnyRole("TECH", "ADMIN")
                        
                        // Payment endpoints - authenticated users
                        .requestMatchers("/api/v1/payments/**").authenticated()
                        
                        // Bicycle management - Admin only for write operations
                        .requestMatchers(HttpMethod.POST, "/api/v1/bicycles/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/bicycles/**").hasAnyRole("TECH", "ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/bicycles/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/v1/bicycles/**").authenticated()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/stations/**").authenticated()
