...
public class BicycleController {
  ...
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Bicycles retrieved successfully")})
  public ResponseEntity<Page<BicycleDto>> findAll(
      @RequestParam(required = false) String model, @PageableDefault Pageable pageable) {
